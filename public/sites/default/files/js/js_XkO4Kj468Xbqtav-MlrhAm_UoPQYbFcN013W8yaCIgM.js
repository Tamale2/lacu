...
(function ($) {
  $(document).ready(function () {
    ...
    var prev_collapse;
    $('.paragraph--type--collapsible-text .collapsible-field-paragraph-text-title').on('click', function () {
      if ($(this).next().is(':hidden')) {
        $(this).next().slideDown(200);
        $(this).css("background-image", "url(/themes/custom/cas/images/icons/arrow-line-up.svg)");
        if (prev_collapse && prev_collapse != this) {
          $(prev_collapse).next().slideUp(200);
          $(prev_collapse).css("background-image", "url(/themes/custom/cas/images/icons/arrow-line-down.svg)");
        }
        prev_collapse = this;
      } else {
        $(this).next().slideUp(200);
        $(this).css("background-image", "url(/themes/custom/cas/images/icons/arrow-line-down.svg)");
      }
    });
  });
})(jQuery);
