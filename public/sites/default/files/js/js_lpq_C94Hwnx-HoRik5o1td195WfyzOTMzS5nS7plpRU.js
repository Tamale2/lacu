    ...
    attach: function attach(context, settings) {
      ...
      $modalLinks.each(function () {
        ...
        $(this).on('click', function (e) {
          ...
          makeModal($(this).attr("data-modal"));
        });
      });

      function makeModal(url) {
        var $modal = $("<div class='media-modal'></div>");
      ...
      function showModal($modal) {
        $modal.appendTo("body").wrapInner("<div class='media-modal__wrapper'></div>");

        $("body").addClass("has-modal");

        var $modalCover = $("<div class='modal__cover'></div>");
        $modalCover.appendTo($modal);
        ...
        if ($(".media--video").length > 0) {
          var timeoutID = setTimeout(function () {
            var videoURL = $(".media--video iframe").prop("src");
            videoURL = videoURL.replace("autoplay=0", "autoplay=1");
            $(".media--video iframe").prop("src", videoURL);
          }, 200);

          var mediaClose = $("<a href='#' class='media__close'>Close</a>");
          mediaClose.appendTo(".media--video").on("click", function (e) {
            hideModal();
            e.preventDefault();
          });
        }
        ...
        if ($(".gallery").length > 0) {
          ...
          var mediaClose = $("<a href='#' class='media__close'>Close</a>");
          mediaClose.appendTo(".gallery--wrapper").on("click", function (e) {
            hideModal();
            e.preventDefault();
          });
        }
