...
var Gallery = function Gallery($) {
  ...
  return {
    init: function init() {
      ...
      var $galleryImages = $(".gallery figure img");

      var $galleryNav = $("<div class='gallery__nav'></div>");

      $galleryImages.each(function () {
        var $imgURL = $(this).attr("src");
        var $thumb = $("<div class='gallery__nav__thumbnail' style='background-image:url(" + $imgURL + ");'></div>");
        $thumb.appendTo($galleryNav).wrap("<div class='gallery__nav__slide'></div>");
      });

      $gallery.after($galleryNav);
      ...
      $(".gallery").slick({
        ...
        swipeToSlide: true,
        draggable: true,
        prevArrow: '<button class="gallery-prev"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="50" viewBox="0 0 28 50"><polygon fill="#ffffff" fill-rule="evenodd" points="26.351 0 1.768 23.447 1.679 23.361 .036 24.928 .126 25.014 0 25.133 1.647 26.705 1.773 26.585 26.319 49.996 27.962 48.431 3.415 25.017 27.998 1.57"/></button>',
        nextArrow: '<button class="gallery-next"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="50" viewBox="0 0 28 50"><polygon fill="#ffffff" fill-rule="evenodd" points="1.647 0 26.23 23.447 26.319 23.361 27.962 24.928 27.872 25.014 27.998 25.133 26.351 26.705 26.225 26.585 1.679 49.996 .036 48.431 24.583 25.017 0 1.57"/></button>',
